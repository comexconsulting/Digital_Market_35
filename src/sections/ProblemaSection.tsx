...
export function ProblemaSection() {
  return (
    <section id="problema" className="mx-auto max-w-6xl px-5 py-28 sm:px-8 md:px-10">
      <div className="grid grid-cols-1 gap-10 lg:grid-cols-2 lg:items-center lg:gap-16">
        ...
        <FadeIn delay={0.2} className="rounded-3xl border border-border-hairline bg-surface-1 p-6 sm:p-8">
          ...
          <p className="mt-4 font-body text-base leading-relaxed text-text-secondary sm:text-lg">
            ...
            producto, otra quiere agendar un turno, la tercera solo quiere el precio. Estás atendiendo a alguien en
            el local. Contestás la primera, la segunda queda en &ldquo;visto&rdquo;, la tercera se cansa de esperar
            y le escribe a la competencia. No la perdiste por mal servicio — la perdiste porque no llegaste a
            tiempo.
          </p>
        </FadeIn>
      </div>
